...
def zwaveEvent(physicalgraph.zwave.commands.centralscenev1.CentralSceneNotification cmd) {
    ...
    if ( cmd.keyAttributes == 0 ) {
        Integer button = 1
        sendEvent(name: "buttonClicks", value: "one click", descriptionText: "$device.displayName was pushed once", isStateChange: true)
        sendEvent(name: "button", value: "pushed", data: [buttonNumber: button], descriptionText: "$device.displayName $button was pushed", isStateChange: true)
        log.debug( "Button was pushed once" )
    }
    if ( cmd.keyAttributes == 3 ) {
        Integer button = 2
        sendEvent(name: "buttonClicks", value: "two clicks", descriptionText: "$device.displayName was pushed twice", isStateChange: true)
        sendEvent(name: "button", value: "pushed", data: [buttonNumber: button], descriptionText: "$device.displayName $button was pushed", isStateChange: true)
        log.debug( "Button was pushed twice" )
    }
    if ( cmd.keyAttributes == 4 ) {
        Integer button = 3
        sendEvent(name: "buttonClicks", value: "three clicks", descriptionText: "$device.displayName was pushed three times", isStateChange: true)
        sendEvent(name: "button", value: "pushed", data: [buttonNumber: button], descriptionText: "$device.displayName $button was pushed", isStateChange: true)
        log.debug( "Button was pushed three times" )
    }
    if ( cmd.keyAttributes == 5 ) {
        Integer button = 4
        sendEvent(name: "buttonClicks", value: "four clicks", descriptionText: "$device.displayName was pushed four times", isStateChange: true)
        sendEvent(name: "button", value: "pushed", data: [buttonNumber: button], descriptionText: "$device.displayName $button was pushed", isStateChange: true)
        log.debug( "Button was pushed four times" )
    }
    if ( cmd.keyAttributes == 6 ) {
        Integer button = 5
        sendEvent(name: "buttonClicks", value: "five clicks", descriptionText: "$device.displayName was pushed five times", isStateChange: true)
        sendEvent(name: "button", value: "pushed", data: [buttonNumber: button], descriptionText: "$device.displayName $button was pushed", isStateChange: true)
        log.debug( "Button was pushed five times" )
    }
    if ( cmd.keyAttributes == 2 ) {
        Integer button = 1
        sendEvent(name: "buttonClicks", value: "hold start", descriptionText: "$device.displayName is held", isStateChange: true)
        sendEvent(name: "button", value: "held", data: [buttonNumber: button], descriptionText: "$device.displayName $button was held", isStateChange: true)
        log.debug( "Button held" )
    }
    if ( cmd.keyAttributes == 1 ) {
        Integer button = 1
        sendEvent(name: "buttonClicks", value: "hold release", descriptionText: "$device.displayName is released", isStateChange: true)
        sendEvent(name: "button", value: "released", data: [buttonNumber: button], descriptionText: "$device.displayName $button was released", isStateChange: true)
